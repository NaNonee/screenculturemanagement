...
public class SpringBootPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        // 设置基本信息
        generatorProperties
                .setMavenModuleName("screenculturemanagement")
                .setParentPackage("com.cpy")
                .setModuleName("screenculturemanagement")
                .setAuthor("wanght")
                .setFileOverride(true);

        // 设置表信息
        generatorProperties.addTable("t_equipment","id");
        // 设置表前缀
        ...
        generatorProperties.getDataSourceConfig()
                ...
                .setUrl("jdbc:mysql://localhost:3306/screenculturemanagement_api?useUnicode=true&characterEncoding=UTF-8&useSSL=false");
